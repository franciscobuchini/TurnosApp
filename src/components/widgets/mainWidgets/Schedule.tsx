...
const SCHEDULE_CLASS = 'relative flex flex-col flex-1 p-0 overflow-hidden rounded-3xl bg-card shadow-xl';
...
const SCHEDULE_SLOT_CELL_CLASS = 'border-t border-neutral-800/60 hover:bg-neutral-800/60';
